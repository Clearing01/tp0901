...
<i class="fa-regular fa-thumbs-up"></i>
							...
							<div id="result1" onclick="lstatus();"><img id="photo1" alt="추천 비활성화" src="images/thumbsUp2.png">0</div>
							<div id="result2" onclick="nlstatus();"><img id="photo2" alt="비추천 비활성화" src="images/thumbsDown2.png">0</div>
							<div id="result3" onclick="report();"><img id="photo3" alt="신고 비활성화" src="images/alert2.png">0</div>
...
<script type="text/javascript">
	function lstatus(){
		var mid = '${member.mid}';
		var bid = '${param.bid}';
		var cnt = document.getElementById('result1').innerHTML;
...
<script type="text/javascript">
	function nlstatus(){
		var mid = '${member.mid}';
		var bid = '${param.bid}';
		var cnt = document.getElementById('result2').innerHTML;
...
<script type="text/javascript">
	function report(){
		var mid = '${member.mid}';
		var bid = '${param.bid}';
		var cnt = document.getElementById('result3').innerHTML;
		console.log('로그: NLstatus');
		$.ajax({
			type: 'POST',
			url: '/Report',
